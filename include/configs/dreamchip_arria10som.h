 ...
 *
 * Based on include/configs/socfpga_arria10.h
...
#define CONFIG_SYS_PROMPT		"DREAMCHIP_ARRIA10SOM # "

/* EMAC controller and PHY used */
#define CONFIG_EMAC_BASE		SOCFPGA_EMAC1_ADDRESS /*DCT::TM SOCFPGA_EMAC0_ADDRESS*/
...
/*DCT::TM ethaddr is set via EEPROM*/
...
#elif defined(CONFIG_MMC) && !defined(CONFIG_CADENCE_QSPI) && !defined(CONFIG_AT24MAC)/*DCT::TM*/
#define CONFIG_BOOTCOMMAND " run mmccore_rbf_prog; run callscript; run mmcload;" \
	"run set_initswstate; run mmcboot"
#define CONFIG_LINUX_DTB_NAME	dreamchip_arria10som_sdmmc.dtb
#define CONFIG_MMC_BOOTPART "2"
#define CONFIG_MMC_LINUXROOT "/dev/mmcblk0p2"
#elif defined(CONFIG_MMC) && defined(CONFIG_CADENCE_QSPI) && defined(CONFIG_AT24MAC) /*DCT::TM*/
#define CONFIG_BOOTCOMMAND " run qspirbfcore_rbf_prog; at24mac; run mmcload;" \
	"run set_initswstate; run mmcboot"
#define CONFIG_LINUX_DTB_NAME	dreamchip_arria10som_qspi.dtb
#define CONFIG_MMC_BOOTPART "1"
#define CONFIG_MMC_LINUXROOT "/dev/mmcblk0p1"
#elif defined(CONFIG_MMC) && defined(CONFIG_CADENCE_QSPI) && !defined(CONFIG_AT24MAC)/*DCT::TM*/
#define CONFIG_BOOTCOMMAND " run qspirbfcore_rbf_prog; run mmcload;" \
	"run set_initswstate; run mmcboot"
#define CONFIG_LINUX_DTB_NAME	dreamchip_arria10som_qspi.dtb
#define CONFIG_MMC_BOOTPART "1"
#define CONFIG_MMC_LINUXROOT "/dev/mmcblk0p1"
...
/* phy */
#define CONFIG_EPHY0_PHY_ADDR		0 /*DCT::TM*/
#endif	/* CONFIG_DESIGNWARE_ETH */


/*DCT::TM add support for at24mac*/
#ifdef CONFIG_AT24MAC
#define CONFIG_AT24MAC_ADDR   	  0x51
#define CONFIG_AT24MAC_EXT_ADDR   0x59
...
#ifndef CONFIG_CADENCE_QSPI /*DCT::TM*/
#define CONFIG_ENV_IS_IN_MMC
#define CONFIG_SYS_MMC_ENV_DEV		0/* device 0 */
#define CONFIG_ENV_OFFSET		512/* just after the MBR */
#define CONFIG_BOOT_FLASH_TYPE "mmc"/*DCT::TM*/
#endif/*DCT::TM*/

#define CONFIG_CMD_FAT
#define CONFIG_CMD_MMC
#define CONFIG_CMD_GPT /*DCT::TM*/
#define CONFIG_PARTITION_UUIDS /*DCT::TM*/
#define CONFIG_EFI_PARTITION /*DCT::TM*/
#define CONFIG_CMD_EXT2 /*DCT::TM*/
#define CONFIG_CMD_EXT4 /*DCT::TM*/
...
#ifndef CONFIG_CADENCE_QSPI /*DCT::TM SD-Card is boot device*/
#define CONFIG_SOCFPGA_DWMMC_DRVSEL     2
#define CONFIG_SOCFPGA_DWMMC_SMPSEL     2
#define CONFIG_SOCFPGA_DWMMC_BUS_WIDTH	4
#else /*DCT::TM QSPI is boot device (eMMC is supported)*/
...
/*DCT::TM #define CONFIG_BOOT_FLASH_TYPE "mmc"*/
#endif	/* CONFIG_MMC */
